...
#Read in files
H3K4me3.CD4.Reactome <- read.table("./Reactome/H3K4me3.CD4.Reactome.txt",
                                header = TRUE, sep = "\t")
H3K4me3.CD8.Reactome <- read.table("./Reactome/H3K4me3.CD8.Reactome.txt",
                                header = TRUE, sep = "\t")
H3K4me3.CD14.Reactome <- read.table("./Reactome/H3K4me3.CD14.Reactome.txt",
                                 header = TRUE, sep = "\t")
...
Reactome.plot.padj <- plot_fn(H3K4me3.Reactome2, scale = c(0, 4.5))
Reactome.plot.padj

ggsave("H3K4me3.Reactome.padj.pdf", Reactome.plot.padj, width = 15, height = 6, useDingbats = FALSE, path = "./figures/")
ggsave("H3K4me3.Reactome.padj.png", Reactome.plot.padj, width = 15, height = 6, device = "png", path = "./figures/")
